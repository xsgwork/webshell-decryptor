package com.xsg.decryptor.godzilla.v3.enums;
...
public enum GodzillaV3DecryptorType {
     ...
     * 所有解密器类都应该位于com.xsg.decryptor.godzilla.v3.core包下
     *
     * @param type 加密器类型枚举值
     * @return 对应的解密器实例
    ...
    public static GodzillaV3Decryptor getDecryptor(GodzillaV3DecryptorType type) {
        try {
            String fullClassName = "com.xsg.decryptor.godzilla.v3.core." + type.getClassName();
