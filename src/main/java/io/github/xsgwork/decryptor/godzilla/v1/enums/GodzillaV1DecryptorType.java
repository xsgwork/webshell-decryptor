package io.github.xsgwork.decryptor.godzilla.v1.enums;
...
public enum GodzillaV1DecryptorType {
     ...
     * 所有解密器类都应该位于io.github.xsgwork.decryptor.godzilla.v1.core包下
     *
     * @param type 加密器类型枚举值
     * @return 对应的解密器实例
    ...
    public static GodzillaV1Decryptor getDecryptor(GodzillaV1DecryptorType type) {
        try {
            String fullClassName = "io.github.xsgwork.decryptor.godzilla.v1.core." + type.getClassName();
