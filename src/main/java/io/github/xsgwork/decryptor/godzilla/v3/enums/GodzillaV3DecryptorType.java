package io.github.xsgwork.decryptor.godzilla.v3.enums;
 ...
 */
@Getter
public enum GodzillaV3DecryptorType {
     ...
     */
    GodzillaV3DecryptorType(String className) {
     ...
     * 所有解密器类都应该位于io.github.xsgwork.decryptor.godzilla.v3.core包下
     *
     * @param type 加密器类型枚举值
     * @return 对应的解密器实例
     * @throws IllegalArgumentException 如果加密器类型不支持或实例化失败
     */
    public static GodzillaV3Decryptor getDecryptor(GodzillaV3DecryptorType type) {
        try {
            String fullClassName = "io.github.xsgwork.decryptor.godzilla.v3.core." + type.getClassName();
            Class<?> clazz = Class.forName(fullClassName);
            return (GodzillaV3Decryptor) clazz.getDeclaredConstructor().newInstance();
        } catch (Exception e) {
